...
const itemBank: ItemBank = {
  items: [
    // --- 變數與資料型別 ---
    {
      id: "PV1", knowledgeId: "py-var", difficulty: 0.2,
    ...
    {
      id: "PV2", knowledgeId: "py-var", difficulty: 0.5,
    ...
    {
      id: "PV3", knowledgeId: "py-var", difficulty: 0.8,
      prompt: "下列哪一個轉型會拋出例外？",
    ...
    // --- 迴圈控制 ---
    {
      id: "PL1", knowledgeId: "py-loop", difficulty: 0.2,
    ...
    {
      id: "PL2", knowledgeId: "py-loop", difficulty: 0.5,
    ...
    {
      id: "PL3", knowledgeId: "py-loop", difficulty: 0.8,
    ...
    // --- 串列 ---
    {
      id: "PS1", knowledgeId: "py-list", difficulty: 0.3,
    ...
    {
      id: "PS2", knowledgeId: "py-list", difficulty: 0.5,
    ...
    {
      id: "PS3", knowledgeId: "py-list", difficulty: 0.8,
