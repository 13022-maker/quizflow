...
const itemBank: ItemBank = {
  items: [
    // --- 變數與資料型別 ---
    {
      id: "V01", knowledgeId: "k-var", difficulty: 0.2,
    ...
    {
      id: "V02", knowledgeId: "k-var", difficulty: 0.4,
    ...
    {
      id: "V03", knowledgeId: "k-var", difficulty: 0.6,
    ...
    {
      id: "V04", knowledgeId: "k-var", difficulty: 0.8,
    ...
    {
      id: "V05", knowledgeId: "k-var", difficulty: 1.0,
    ...
    // --- 迴圈控制 ---
    {
      id: "L01", knowledgeId: "k-loop", difficulty: 0.1,
    ...
    {
      id: "L02", knowledgeId: "k-loop", difficulty: 0.3,
    ...
    {
      id: "L03", knowledgeId: "k-loop", difficulty: 0.5,
    ...
    {
      id: "L04", knowledgeId: "k-loop", difficulty: 0.7,
    ...
    {
      id: "L05", knowledgeId: "k-loop", difficulty: 0.9,
    ...
    {
      id: "L06", knowledgeId: "k-loop", difficulty: 0.2,
    ...
    {
      id: "L07", knowledgeId: "k-loop", difficulty: 0.4,
    ...
    {
      id: "L08", knowledgeId: "k-loop", difficulty: 0.6,
    ...
    // --- 一維陣列 ---
    {
      id: "A01", knowledgeId: "k-array", difficulty: 0.3,
    ...
    {
      id: "A02", knowledgeId: "k-array", difficulty: 0.5,
    ...
    {
      id: "A03", knowledgeId: "k-array", difficulty: 0.8,
