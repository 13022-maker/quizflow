...
export default function NewVocabPage() {
  ...
  return (
    <div className="mx-auto max-w-lg px-4 py-8">
      ...
      {/* 標題 */}
      <div className="mb-4">
        <label className="mb-1 block text-sm font-medium">卡集名稱</label>
        <input
          type="text"
          value={title}
      ...
      {/* 輸入單字 */}
      <div className="mb-4">
        <label className="mb-1 block text-sm font-medium">輸入單字清單</label>
        <textarea
          value={words}
          onChange={e => setWords(e.target.value)}
          placeholder={'每行一個單字，例如：\napple\nbanana\nstrawberry'}
          rows={5}
          className="w-full resize-none rounded-xl border px-4 py-3 text-sm placeholder:text-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-400"
        />
      </div>
