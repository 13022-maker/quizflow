                ...
                <div className="mb-4">
                  <label className="mb-2 block text-sm font-medium text-gray-700">
                    ...
                    <textarea
                      ...
                      rows={6}
                      className="mt-2 w-full resize-none rounded-xl border border-gray-200 px-4 py-3 text-sm placeholder:text-gray-300 focus:border-transparent focus:outline-none focus:ring-2 focus:ring-blue-400"
                    />
                  </label>
                </div>
